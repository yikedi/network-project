...
public class CSftp {
        ...
        try {
            ...
            for (int len = 1; len > 0; ) {
                ...
                try {
                    ...
                    System.out.println("0xFFFC Control connection to " + args[0] + " on port " + args[1] + " failed to open");
                    return;
                }
                    ...
                    case "get": {
                        ...
                        try {
                            ...
                            if (command2 == null || wrong_num_arg) {
                                ...
                                InputStream data_transfer_reader=data_transfer.getInputStream();
                                ...
                                if (code.equals("226")) {
                                    ...
                                    try {
                                        ...
                                        int data_transfer_output =0;
                                        while ((data_transfer_output=data_transfer_reader.read())!=-1){
                                            System.out.println("<-- "+data_transfer_output);
                                            outputStream.write(data_transfer_output);
                                        }
                                        System.out.println("File is now in src folder");
                                        outputStream.close();
                    ...
                    case "dir": {
                        ...
                        try {
                            ...
                            if (command2 != null || wrong_num_arg) {
                                ...
                                BufferedReader data_reader = new BufferedReader(new InputStreamReader(data_transfer.getInputStream()));
            ...
            if (exception instanceof IOException) {
                ...
                System.err.println("0xFFFF Processing error. "+ exception.getMessage());
            }
        }
    ...
    public static void do_username(BufferedReader stdIn, BufferedReader socketIn, PrintWriter out, String userInput) throws IOException {
...
//            System.out.println(ip_address);
            ...
            try {
                ...
                System.out.println("0x3A2 Data transfer connection to" + new_address + "on port" + port_number + "failed to open");
            }
        }
